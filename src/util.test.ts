...
describe('validateTriggers', () => {
  ...
  it('should not contain unsupported keys', () => {
    ...
    expect(res).toEqual(`Invalid key 'invalid' found in 'triggers' clause in project.yml`)
  })
  ...
  it('should have a valid SCHEDULED details', () => {
    ...
    expect(res).toEqual(`the cron expression 'foo' is not valid crontab syntax`)
    ...
    expect(res).toEqual(`the 'body' member of scheduledDetails must be a dictionary`)
